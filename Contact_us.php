...
<body>
    ...
    <div class="w-full py-24 px-6 bg-cover  bg-no-repeat bg-center relative z-10"
        style="background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(pics/contact_us.jpg);">

        <div class="container max-w-4xl mx-auto text-center">
            <h1 class="text-xl font-bold leading-tight md:text-3xl text-center text-gray-100 mb-3">CONTACT US NOW</h1>
        </div>

    </div>
    <!-- HR Section -->
    <hr style="border: 40px solid white;">
    <!-- Contact Us Section -->
    ...
    <!-- Another Contact Information Provider -->
    <section class="text-gray-700 body-font relative">
